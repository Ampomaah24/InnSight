...
import "../assets/styles/Dashboard.css"; // Import styles
import Navbar from "../pages/Navbar"; // Import Navbar


const Dashboard = () => {
  // Dummy reservation data for frontend testing
    ...
    <div className="dashboard-container">
      ...
      <div className="summary-cards">
        ...
        <div className="card">
          ...
          <span className="positive-change">+20%</span>
        </div>
        <div className="card">
          <p className="card-title">Rooms Occupied</p>
          <h2 className="card-value">12</h2>
          <span className="negative-change">-5%</span>
        </div>
      </div>
